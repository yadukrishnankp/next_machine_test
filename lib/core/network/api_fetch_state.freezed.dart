...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApiFetchState<T>);
}
...
/// @nodoc
class $ApiFetchStateCopyWith<T,$Res>  {
$ApiFetchStateCopyWith(ApiFetchState<T> _, $Res Function(ApiFetchState<T>) __);
}


/// Adds pattern-matching-related methods to [ApiFetchState].
extension ApiFetchStatePatterns<T> on ApiFetchState<T> {
...
class Initial<T> implements ApiFetchState<T> {
  const Initial();
...
@override
String toString() {
  return 'ApiFetchState<$T>.initial()';
}
...
class Loading<T> implements ApiFetchState<T> {
  const Loading();
...
@override
String toString() {
  return 'ApiFetchState<$T>.loading()';
}
...
class Success<T> implements ApiFetchState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of ApiFetchState
...
@override
String toString() {
  return 'ApiFetchState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ApiFetchStateCopyWith<T, $Res> {
...
class Failure<T> implements ApiFetchState<T> {
...
@override
String toString() {
  return 'ApiFetchState<$T>.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $ApiFetchStateCopyWith<T, $Res> {
